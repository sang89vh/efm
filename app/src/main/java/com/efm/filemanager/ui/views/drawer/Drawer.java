...
import com.efm.filemanager.BuildConfig;
...
import com.efm.filemanager.utils.ScreenUtils;
...
public class Drawer implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public Drawer(MainActivity mainActivity) {
        ...
        drawerHeaderView.setBackgroundResource(R.drawable.efm_header);
        ...
        if (!isDrawerLocked) {
            mDrawerToggle = new ActionBarDrawerToggle(
                ...
                public void onDrawerOpened(View drawerView) {
                    //title.setText("efm File Manager");
        ...
        try {
            ...
            mImageLoader.get(path1, new ImageLoader.ImageListener() {
                ...
                public void onResponse(ImageLoader.ImageContainer response, boolean isImmediate) {
                    ...
                    drawerHeaderView.setBackgroundResource(R.drawable.efm_header_2);
                }
